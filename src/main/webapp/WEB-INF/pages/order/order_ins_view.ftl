...
<div class="container" id="enlarge-body">
	...
	<form class="form-inline well" action="/order/view/" method="POST">
		...
		<div class="input-group">
			<div class="input-group-addon">订单总价：${order.price}</div>
	    </div>
		<div class="input-group">
		...
		<div class="input-group">
			<div class="input-group-addon">生单时间：${order.createdAt?string("yyyy-MM-dd HH:mm:ss")}
			</div>
		</div>
	</form>
